...
| LIFE-001 | Reopen Closed Batch | CONTROL | Confirmed control boundary 2026-09-04: Reopen is ERP lifecycle control. Reopen lifecycle state without deleting prior Close Audit or rewriting prior immutable Inventory Movement / BATCH_RECONCILIATION history. Physical inventory mismatch is handled by stocktake / AdjustInventory. |
