...
public sealed class SalesProduct : IHasRowVersion
{
    public Guid Id { get; private set; }
    public Guid SalesProductGroupId { get; private set; }
    public string? NameZhTw { get; private set; }
    public string? NameThTh { get; private set; }
    public SalesPricingBasis PricingBasis { get; private set; }
    public decimal? PackagingWeight { get; private set; }
    public decimal? SalesWeight { get; private set; }
