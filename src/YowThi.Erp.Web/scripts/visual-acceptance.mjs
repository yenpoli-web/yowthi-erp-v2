...
const cases = [
  ...
  { name: 'desktop-processing', experience: 'desktop', width: 1440, height: 900, path: '/processing' },
  { name: 'desktop-processing-new', experience: 'desktop', width: 1440, height: 900, path: '/processing/executions/new' },
  ...
  { name: 'tablet-processing', experience: 'tablet', width: 1024, height: 768, path: '/processing' },
  { name: 'tablet-processing-new', experience: 'tablet', width: 1024, height: 768, path: '/processing/executions/new' },
  ...
  { name: 'mobile-processing', experience: 'mobile', width: 390, height: 844, path: '/processing' },
  { name: 'mobile-processing-new', experience: 'mobile', width: 390, height: 844, path: '/processing/executions/new' },
