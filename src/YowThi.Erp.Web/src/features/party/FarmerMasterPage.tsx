...
const copy = {
  'zh-TW': {
    eyebrow: '夥伴管理', title: '農戶', newFarmer: '新增農戶', search: '搜尋名稱、電話或銀行', supplierTab: '農戶', customerTab: '客戶',
  ...
  'th-TH': {
    eyebrow: 'จัดการคู่ค้า', title: 'เกษตรกร', newFarmer: 'เพิ่มเกษตรกร', search: 'ค้นหาชื่อ โทรศัพท์ หรือธนาคาร', supplierTab: 'เกษตรกร', customerTab: 'ลูกค้า',
