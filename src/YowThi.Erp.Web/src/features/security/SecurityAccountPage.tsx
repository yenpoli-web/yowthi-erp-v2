...
const capabilityLabels: Record<string, { 'zh-TW': string; 'th-TH': string }> = {
  ...
  'procurement.transaction.lifecycle': { 'zh-TW': '採購交易刪除控制', 'th-TH': 'ควบคุมวงจรข้อมูลธุรกรรมจัดซื้อ' },
  'processing.confirm': { 'zh-TW': '加工登記', 'th-TH': 'บันทึกการแปรรูป' },
  'processing.transaction.lifecycle': { 'zh-TW': '加工交易刪除控制', 'th-TH': 'ควบคุมวงจรข้อมูลการแปรรูป' },
  'outsourced.confirm': { 'zh-TW': '委外登記', 'th-TH': 'บันทึกงานภายนอก' },
  'outsourced.transaction.lifecycle': { 'zh-TW': '委外交易刪除控制', 'th-TH': 'ควบคุมวงจรข้อมูลการจัดหาภายนอก' },
  'sales.confirm': { 'zh-TW': '銷售確認', 'th-TH': 'ยืนยันการขาย' },
  'sales.correct-allocation': { 'zh-TW': '銷售配置修正', 'th-TH': 'แก้ไขการจัดสรรการขาย' },
  'sales.transaction.lifecycle': { 'zh-TW': '銷售交易刪除控制', 'th-TH': 'ควบคุมวงจรข้อมูลการขาย' },
  ...
  'product.procurement-product.manage': { 'zh-TW': '採購產品管理', 'th-TH': 'จัดการสินค้าจัดซื้อ' },
  'product.sales-product.manage': { 'zh-TW': '銷售產品管理', 'th-TH': 'จัดการสินค้าขาย' },
  ...
  'infrastructure.warehouse.manage': { 'zh-TW': '倉庫管理', 'th-TH': 'จัดการคลังสินค้า' },
  'infrastructure.warehouse.lifecycle': { 'zh-TW': '倉庫控制', 'th-TH': 'ควบคุมคลังสินค้า' },
  'infrastructure.storage-location.manage': { 'zh-TW': '儲位管理', 'th-TH': 'จัดการตำแหน่งจัดเก็บ' },
  ...
  'inventory.view': { 'zh-TW': '庫存查詢', 'th-TH': 'ดูสินค้าคงคลัง' },
